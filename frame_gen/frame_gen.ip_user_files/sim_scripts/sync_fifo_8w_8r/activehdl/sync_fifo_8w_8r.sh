...
#                script (type 'sync_fifo_8w_8r.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/PC/Desktop/fps/frame_gen/frame_gen/frame_gen.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
