...
#
# Script generated by Vivado on Fri Oct 10 15:02:34 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sync_fifo_8w_8r.sh
...
#
# Usage        : sync_fifo_8w_8r.sh
#                sync_fifo_8w_8r.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sync_fifo_8w_8r.sh [-reset_run]
#                sync_fifo_8w_8r.sh [-reset_log]
#                sync_fifo_8w_8r.sh [-help]
#
...
export RDI_DATADIR="D:/2024_2/Vivado/2024.2/data"
...
# script info
echo -e "sync_fifo_8w_8r.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sync_fifo_8w_8r.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 32  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sync_fifo_8w_8r xil_defaultlib.sync_fifo_8w_8r xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sync_fifo_8w_8r -key {Behavioral:sim_1:Functional:sync_fifo_8w_8r} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/2024_2/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sync_fifo_8w_8r.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sync_fifo_8w_8r.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sync_fifo_8w_8r.sh [-help]\n\
Usage: sync_fifo_8w_8r.sh [-step]\n\
Usage: sync_fifo_8w_8r.sh [-lib_map_path]\n\
Usage: sync_fifo_8w_8r.sh [-reset_run]\n\
Usage: sync_fifo_8w_8r.sh [-reset_log]\n\
Usage: sync_fifo_8w_8r.sh [-keep_index]\n\
Usage: sync_fifo_8w_8r.sh [-noclean_files]\n\n\
